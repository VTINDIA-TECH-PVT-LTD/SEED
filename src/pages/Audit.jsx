...
export default function Audit() {
  ...
  const audit2025 = [
    { id: 1, description: "Audit Report 2024-25", file: "/uploads/demo.pdf" },
    { id: 2, description: "Financial Audit 2025", file: "/uploads/demo.pdf" },
  ];

  const audit2024 = [
    { id: 1, description: "Audit Report 2023-24", file: "/uploads/demo.pdf" },
    { id: 2, description: "Financial Audit 2024", file: "/uploads/demo.pdf" },
  ];

  // Pick data based on active year
  const reports = activeYear === "2025" ? audit2025 : audit2024;
